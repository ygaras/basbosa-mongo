...
var BackboneMongoStatic = {
    ...
    getDb : function(cb, useCb) {
        var connection = Cm.getDb(this.connectionName);
        if (connection !== false && typeof cb === 'function') return cb(connection);
...
BasbosaModel.extend = function(protoProps, staticProps) {
...
Basbosa.add('BasbosaModel', BackboneMongo);
